...
{{ Form::model($anime,array('route' => array('admin.descarga.store'),
'method' => 'POST',
'class' => 'form-horizontal', 'role' => 'form',
)) }}


    <h1><b>{{$anime->titulo_romaji}}</b> : Agregar Descarga</h1>
    <hr>
    ...
    <div class="row">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="submit" class="btn btn-primary" value="Agregar Descarga">
          <span></span>
